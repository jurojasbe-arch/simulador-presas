...
def modelar_flujo(Lx, prof_muro, pos_muro_rel, dx=0.5, k=1e-5, Gs=2.65, e=0.65, h1=50.0, h2=5.0):
    # Parámetros fijos
    ...
    # Posición del muro relativa al inicio de la presa
    idx_x_muro = int((x_inicio + pos_muro_rel) / dx)
    ...
    # Máscaras de dibujo para que las flechas no atraviesen el concreto
